  ...
  if (req.method === 'GET') {
    try {
      ...
      if (!balanceSheet) {
        return res
          .status(404)
          .json({ message: 'balance sheet Report not found' });
      }
      ...
      if (!cashFlow) {
        return res.status(404).json({ message: ' cash flow Report not found' });
      }
      ...
      if (!comprehensiveIncome) {
        return res
          .status(404)
          .json({ message: 'comprehensive income Report not found' });
      }
      ...
      const data = {
        ...
        comprehensiveIncome: {
          ...
          operatingExpenses: {
            ...
            details: {
              ...
              marketing:
                comprehensiveIncome.operatingExpenses_details_marketing, //B019
              rebateExpenses: {
                weightedAverageCost:
          ...
          otherGainLosses: {
            ...
            details: {
              ...
              forexGains:
                comprehensiveIncome.otherGainsLosses_details_forexGains, //B027
              cryptocurrencyGains: {
                weightedAverageCost:
        ...
        cashFlow: {
          ...
          operatingActivities: {
            weightedAverageCost:
              cashFlow.operatingActivities_weightedAverageCost, //C041
            details: {
          ...
          investingActivities: {
            weightedAverageCost:
              cashFlow.investingActivities_weightedAverageCost, //C042
          },

          financingActivities: {
            weightedAverageCost:
              cashFlow.financingActivities_weightedAverageCost, //C048
            details: {
