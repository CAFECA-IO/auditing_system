...
export default async function handler(req, res) {
  ...
  const data = {
    ...
    income: {
      ...
      details: {
        depositFee: {
          weightedAverageCost: income_details_depositFee_weightedAverageCost, //B001
          breakdown: {
            USDT: {
              amount: income_details_depositFee_breakdown_USDT_amount, //B002
              weightedAverageCost:
                income_details_depositFee_breakdown_USDT_weightedAverageCost, //B003
            },
            ETH: {
              amount: income_details_depositFee_breakdown_ETH_amount, //B034
              weightedAverageCost:
                income_details_depositFee_breakdown_ETH_weightedAverageCost, //B035
            },
            BTC: {
              amount: income_details_depositFee_breakdown_BTC_amount, //B036
              weightedAverageCost:
                income_details_depositFee_breakdown_BTC_weightedAverageCost, //B037
            },
            USD: {
              amount: income_details_depositFee_breakdown_USD_amount, //B038
              weightedAverageCost:
        ...
        withdrawalFee: {
          weightedAverageCost: income_details_withdrawalFee_weightedAverageCost, //B005
          breakdown: {
            USDT: {
              amount: income_details_withdrawalFee_breakdown_USDT_amount, //B006
              weightedAverageCost:
                income_details_withdrawalFee_breakdown_USDT_weightedAverageCost, //B007
            },
            ETH: {
              amount: income_details_withdrawalFee_breakdown_ETH_amount, //B040
              weightedAverageCost:
                income_details_withdrawalFee_breakdown_ETH_weightedAverageCost, //B041
            },
            BTC: {
              amount: income_details_withdrawalFee_breakdown_BTC_amount, //B042
              weightedAverageCost:
                income_details_withdrawalFee_breakdown_BTC_weightedAverageCost, //B043
            },
            USD: {
              amount: income_details_withdrawalFee_breakdown_USD_amount, //B044
              weightedAverageCost:
        ...
        tradingFee: {
          ...
          breakdown: {
            ETH: {
              amount: income_details_transactionFee_breakdown_ETH_amount, //B046
              weightedAverageCost:
                income_details_transactionFee_breakdown_ETH_weightedAverageCost, //B047
            },
            BTC: {
              amount: income_details_transactionFee_breakdown_BTC_amount, //B048
              weightedAverageCost:
                income_details_transactionFee_breakdown_BTC_weightedAverageCost, //B049
            },
            USDT: {
              amount: income_details_transactionFee_breakdown_USDT_amount, //B050
              weightedAverageCost:
                income_details_transactionFee_breakdown_USDT_weightedAverageCost, //B051
            },
            USD: {
              amount: income_details_transactionFee_breakdown_USD_amount, //B052
              weightedAverageCost:
      ...
      spreadFee: {
        weightedAverageCost: income_details_spreadFee_weightedAverageCost, //B012
        breakdown: {
          ETH: {
            amount: income_details_spreadFee_breakdown_ETH_amount, //B054
            weightedAverageCost:
              income_details_spreadFee_breakdown_ETH_weightedAverageCost, //B055
          },
          BTC: {
            amount: income_details_spreadFee_breakdown_BTC_amount, //B056
            weightedAverageCost:
              income_details_spreadFee_breakdown_BTC_weightedAverageCost, //B057
          },
          USDT: {
            amount: income_details_spreadFee_breakdown_USDT_amount, //B058
            weightedAverageCost:
              income_details_spreadFee_breakdown_USDT_weightedAverageCost, //B059
          },
          USD: {
            amount: income_details_spreadFee_breakdown_USD_amount, //B060
            weightedAverageCost:
      ...
      liquidationFee: {
        weightedAverageCost: income_details_liquidationFee_weightedAverageCost, //B013
        breakdown: {
          ETH: {
            amount: income_details_liquidationFee_breakdown_ETH_amount, //B062
            weightedAverageCost:
              income_details_liquidationFee_breakdown_ETH_weightedAverageCost, //B063
          },
          BTC: {
            amount: income_details_liquidationFee_breakdown_BTC_amount, //B064
            weightedAverageCost:
              income_details_liquidationFee_breakdown_BTC_weightedAverageCost, //B065
          },
          USDT: {
            amount: income_details_liquidationFee_breakdown_USDT_amount, //B066
            weightedAverageCost:
              income_details_liquidationFee_breakdown_USDT_weightedAverageCost, //B067
          },
          USD: {
            amount: income_details_liquidationFee_breakdown_USD_amount, //B068
            weightedAverageCost:
      ...
      guaranteedStopLossFee: {
        ...
        breakdown: {
          ETH: {
            amount: income_details_guaranteedStopFee_breakdown_ETH_amount, //B070
            weightedAverageCost:
              income_details_guaranteedStopFee_breakdown_ETH_weightedAverageCost, //B071
          },
          BTC: {
            amount: income_details_guaranteedStopFee_breakdown_BTC_amount, //B072
            weightedAverageCost:
              income_details_guaranteedStopFee_breakdown_BTC_weightedAverageCost, //B073
          },
          USDT: {
            amount: income_details_guaranteedStopFee_breakdown_USDT_amount, //B074
            weightedAverageCost:
              income_details_guaranteedStopFee_breakdown_USDT_weightedAverageCost, //B075
          },
          USD: {
            amount: income_details_guaranteedStopFee_breakdown_USD_amount, //B076
            weightedAverageCost:
    ...
    costs: {
      ...
      details: {
        technicalProviderFee: {
          ...
          breakdown: {
            ETH: {
              amount: costs_details_technicalProviderFee_breakdown_ETH_amount, //B009
              weightedAverageCost:
                costs_details_technicalProviderFee_breakdown_ETH_fairValue, //B010
            },
            BTC: {
              amount: costs_details_technicalProviderFee_breakdown_BTC_amount, //B094
              weightedAverageCost:
                costs_details_technicalProviderFee_breakdown_BTC_weightedAverageCost, //B095
            },
            USDT: {
              amount: costs_details_technicalProviderFee_breakdown_USDT_amount, //B096
              weightedAverageCost:
                costs_details_technicalProviderFee_breakdown_USDT_weightedAverageCost, //B097
            },
            USD: {
              amount: costs_details_technicalProviderFee_breakdown_USD_amount, //B098
              weightedAverageCost:
    ...
    operatingExpenses: {
      weightedAverageCost: operatingExpenses_weightedAverageCost, //B031
      details: {
        salaries: operatingExpenses_details_salaries, //B017
        rent: operatingExpenses_details_rent, //B018
        marketing: operatingExpenses_details_marketing, //B019
        rebateExpenses: {
          weightedAverageCost:
    ...
    financialCosts: {
      weightedAverageCost: financialCosts_weightedAverageCost, //B032
      details: {
        interestExpense: financialCosts_details_interestExpense, //B021
        cryptocurrencyForexLosses: {
          weightedAverageCost: financialCosts_details_cryptocurrencyForexLosses, //B022
          breakdown: {
            ETH: {
              amount:
    ...
    otherGainLosses: {
      weightedAverageCost: otherGainsLosses_weightedAverageCost, //B033
      details: {
        investmentGains: otherGainsLosses_details_investmentGains, //B026
        forexGains: otherGainsLosses_details_forexGains, //B027
        cryptocurrencyGains: {
          weightedAverageCost:
