...
describe('checking E00020010 balanceSheet', async function () {
  ...
  it('liabilities.details.userDeposit.totalAmountFairValue should equal -1700000000000000000000', async function () {
  ...
  it(' liabilities.details.userDeposit.breakdown.USD.amount should equal  -1700000000000000000000 ', async function () {
    const value = await contractWithSigner.getValue(
      'eighteenth_report',
      'balanceSheet',
  ...
  it('liabilities.details.userDeposit.breakdown.USD.fairValue should equal -1700000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'eighteenth_report',
      'balanceSheet',
  ...
  it('liabilities.details.accountsPayable.totalAmountFairValue should equal 1700000000000000000000 ', async function () {
    const value = await contractWithSigner.getValue(
      'eighteenth_report',
      'balanceSheet',
  ...
  it('liabilities.details.accountsPayable.breakdown.USD.amount should equal 1700000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'eighteenth_report',
      'balanceSheet',
  ...
  it('liabilities.details.accountsPayable.breakdown.USD.fairValue should equal 1700000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'eighteenth_report',
      'balanceSheet',
