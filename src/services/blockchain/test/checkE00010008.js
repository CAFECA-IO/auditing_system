...
describe('checking E00010008 balanceSheet', function () {
  it('assets.details.cashAndCashEquivalent.totalAmountFairValue should equal -99.905', async function () {
    ...
    expect(valueString).to.equal('-99.905');
  });

  it('assets.details.cashAndCashEquivalent.breakdown.USD.amount should equal -99.905', async function () {
    const value = await contractWithSigner.getValue(
      'eighth_report',
      'balanceSheet',
  ...
  it('assets.details.cashAndCashEquivalent.breakdown.USD.fairValue should equal -99.905', async function () {
    const value = await contractWithSigner.getValue(
      'eighth_report',
      'balanceSheet',
  ...
  it('assets.totalAmountFairValue should equal -99.905', async function () {
    const value = await contractWithSigner.getValue(
      'eighth_report',
      'balanceSheet',
  ...
  it('totalAssetsFairValue should equal -99.905', async function () {
    const value = await contractWithSigner.getValue(
      'eighth_report',
      'balanceSheet',
  ...
  it('totalLiabilitiesAndEquityFairValue should equal  -99.905', async function () {
    const value = await contractWithSigner.getValue(
      'eighth_report',
      'balanceSheet',
...
describe('checking E00010008 cashFlow', function () {
  ...
  it('operatingActivities.weightedAverageCost should equal -99.905', async function () {
    const value = await contractWithSigner.getValue(
      'eighth_report',
      'comprehesiveIncome',
  ...
  it('otherSupplementaryItems.details.relatedToCash.cashCashEquivalentsAndRestrictedCashEndOfPeriod.weightedAverageCost should equal -99.905', async function () {
    const value = await contractWithSigner.getValue(
      'eighth_report',
      'comprehesiveIncome',
