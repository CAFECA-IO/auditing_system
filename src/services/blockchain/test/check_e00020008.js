...
describe('checking E00020008 balanceSheet', async function () {
  ...
  it('liabilities.details.userDeposit.totalAmountFairValue should equal -1584000000000000000000', async function () {
  ...
  it(' liabilities.details.userDeposit.breakdown.USDT.amount should equal  -1600000000000000000000 ', async function () {
    const value = await contractWithSigner.getValue(
      'sixteenth_report',
      'balanceSheet',
  ...
  it('liabilities.details.userDeposit.breakdown.USDT.fairValue should equal -1584000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'sixteenth_report',
      'balanceSheet',
  ...
  it('liabilities.details.accountsPayable.totalAmountFairValue should equal 1584000000000000000000 ', async function () {
    const value = await contractWithSigner.getValue(
      'sixteenth_report',
      'balanceSheet',
  ...
  it('liabilities.details.accountsPayable.breakdown.USDT.amount should equal 1600000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'sixteenth_report',
      'balanceSheet',
  ...
  it('liabilities.details.accountsPayable.breakdown.USDT.fairValue should equal 1584000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'sixteenth_report',
      'balanceSheet',
