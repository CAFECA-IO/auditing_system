...
describe('checking E00020011 balanceSheet', async function () {
  ...
  it('liabilities.details.userDeposit.totalAmountFairValue should equal -2800000000000000000000', async function () {
  ...
  it(' liabilities.details.userDeposit.breakdown.USD.amount should equal  -2800000000000000000000 ', async function () {
    const value = await contractWithSigner.getValue(
      'nineteenth_report',
      'balanceSheet',
  ...
  it('liabilities.details.userDeposit.breakdown.USD.fairValue should equal -2800000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'nineteenth_report',
      'balanceSheet',
  ...
  it('liabilities.details.accountsPayable.totalAmountFairValue should equal 2800000000000000000000 ', async function () {
    const value = await contractWithSigner.getValue(
      'nineteenth_report',
      'balanceSheet',
  ...
  it('liabilities.details.accountsPayable.breakdown.USD.amount should equal 2800000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'nineteenth_report',
      'balanceSheet',
  ...
  it('liabilities.details.accountsPayable.breakdown.USD.fairValue should equal 2800000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'nineteenth_report',
      'balanceSheet',
