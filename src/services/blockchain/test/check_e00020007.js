...
describe('checking E00020007 balanceSheet', async function () {
  ...
  it('liabilities.details.accountsPayable.breakdown.USDT.amount should equal 2800000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'fifteenth_report',
      'balanceSheet',
  ...
  it('liabilities.details.accountsPayable.breakdown.USDT.fairValue should equal 2772000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'fifteenth_report',
      'balanceSheet',
