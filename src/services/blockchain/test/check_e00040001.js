...
describe('checking E00040001 balanceSheet', function () {
  ...
  it('assets.details.cryptocurrency.totalAmountFairValue should equal -1745000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentyninth_report',
      'balanceSheet',
      'assets.details.cryptocurrency.totalAmountFairValue',
    );
    expect(value).to.equal('-1745000000000000000000');
  });
  //
  ...
  //
  it('assets.details.cryptocurrency.breakdown.USDT.amount should equal 24500000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentyninth_report',
      'balanceSheet',
      'assets.details.cryptocurrency.breakdown.USDT.amount',
    );
    expect(value).to.equal('24500000000000000000000');
  });
  //
  it('assets.details.cryptocurrency.breakdown.USDT.fairValue should equal 24255000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentyninth_report',
      'balanceSheet',
      'assets.details.cryptocurrency.breakdown.USDT.fairValue',
    );
    expect(value).to.equal('24255000000000000000000');
  });
  //
  it('assets.totalAmountFairValue should equal -1745000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentyninth_report',
      'balanceSheet',
  ...
  //
  it('totalAssetsFairValue should equal -1745000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentyninth_report',
      'balanceSheet',
  ...
  //
  it('liabilities.details.userDeposit.totalAmountFairValue should equal -1745000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentyninth_report',
      'balanceSheet',
  ...
  //
  it('liabilities.details.userDeposit.breakdown.USDT.amount  should equal 24500000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentyninth_report',
      'balanceSheet',
  ...
  //
  it('liabilities.details.userDeposit.breakdown.USDT.fairValue  should equal 24255000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentyninth_report',
      'balanceSheet',
  ...
  //
  it('liabilities.totalAmountFairValue  should equal -1745000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentyninth_report',
      'balanceSheet',
  ...
  //
  it('totalLiabilitiesAndEquityFairValue should equal -1745000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentyninth_report',
      'balanceSheet',
