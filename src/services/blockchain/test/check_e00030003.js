...
describe('checking E00030003 balanceSheet', function () {
  ...
  //
  it('assets.totalAmountFairValue  should equal 1686366000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentythird_report',
      'balanceSheet',
      'assets.totalAmountFairValue',
    );
    expect(value).to.equal('1686366000000000000000');
  });
  //
  it('totalAssetsFairValue  should equal 1686366000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentythird_report',
      'balanceSheet',
  ...
  //
  it('liabilities.details.accountsPayable.totalAmountFairValue  should equal 1936600000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentythird_report',
      'balanceSheet',
      'liabilities.details.accountsPayable.totalAmountFairValue',
    );
    expect(value).to.equal('1936600000000000000000');
  });
  //
  ...
  //
  it('liabilities.details.accountsPayable.breakdown.BTC.fairValue  should equal 1600000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentythird_report',
      'balanceSheet',
  ...
  //
  it('liabilities.details.accountsPayable.breakdown.USDT.amount  should equal 340000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentythird_report',
      'balanceSheet',
  ...
  //
  it('liabilities.details.accountsPayable.breakdown.USDT.fairValue  should equal 336600000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentythird_report',
      'balanceSheet',
  ...
  it('equity.details.otherCapitalReserve.fairValue should equal 83000000000000000000', async function () {
    ...
    expect(value).to.equal('83000000000000000000');
  });
  //
  ...
  //
  it('equity.details.otherCapitalReserve.breakdown.BTC.fairValue should equal -1600000000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentythird_report',
      'balanceSheet',
  ...
  it('equity.totalAmountFairValue should equal 86366000000000000000', async function () {
    ...
    expect(value).to.equal('86366000000000000000');
  });
  //
  it('totalLiabilitiesAndEquityFairValue should equal 1686366000000000000000', async function () {
    const value = await contractWithSigner.getValue(
      'twentythird_report',
      'balanceSheet',
...
describe('checking E00030003 comprehensive income', function () {
  before(async function () {
    const [signer] = await ethers.getSigners();
    contractWithSigner = new ethers.Contract(
      routerContractAddress,
