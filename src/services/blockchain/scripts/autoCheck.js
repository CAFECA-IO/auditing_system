...
async function main() {
  try {
    ...
    console.log(
      '\x1b[34m%s\x1b[0m',
      '------Auto running npx hardhat test  src/services/blockchain/test/checkE00010005.js command...------',
    );
    await runCommand(
      'npx hardhat test  src/services/blockchain/test/checkE00010005.js',
    );
    //
    ...
    console.log(
      '\x1b[34m%s\x1b[0m',
      '------Auto running npx hardhat test  src/services/blockchain/test/checkE00010006.js command...------',
    );
    await runCommand(
      'npx hardhat test  src/services/blockchain/test/checkE00010006.js',
    );
    //
    ...
    console.log(
      '\x1b[34m%s\x1b[0m',
      '------Auto running npx hardhat test  src/services/blockchain/test/checkE00010007.js command...------',
    );
    await runCommand(
      'npx hardhat test  src/services/blockchain/test/checkE00010007.js',
    );
    //
    ...
    console.log(
      '\x1b[34m%s\x1b[0m',
      '------Auto running npx hardhat test  src/services/blockchain/test/checkE00010008.js command...------',
    );
    await runCommand(
      'npx hardhat test  src/services/blockchain/test/checkE00010008.js',
    );
  } catch (error) {}
}
