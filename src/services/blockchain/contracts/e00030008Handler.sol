...
contract E00030005Handler is ITransactionHandler{
    ...
    function computeBalanceSheet() internal  {
        ...
        report.addValue(reportID, "balanceSheet", "assets.details.accountsReceivable.totalAmountFairValue" , A020_030_004_005);
        report.addValue(reportID, "balanceSheet", "assets.details.accountsReceivable.breakdown.ETH.fairValue" , A020_030_004_005);
        report.addValue(reportID, "balanceSheet", "assets.totalAmountFairValue" , A020_030_004_005);
        report.addValue(reportID, "balanceSheet", "totalAssetsFairValue" , A020_030_004_005);

        int256 A029 = int256((-EP003) + (-EP012));
        report.addValue(reportID, "balanceSheet", "assets.details.accountsReceivable.breakdown.ETH.amount" , A029);
