...
contract E00030002Handler is ITransactionHandler{
    ...
    function processTransaction(bytes32[] memory data, address recorder) external override {
        ...
        require(data.length == 10, "Data length for E00030002 must be 10");
    ...
    function computeBalanceSheet() internal  {
        ...
        int256 A027 = EP001 ;
        report.addValue(reportID, "balanceSheet", "assets.details.accountsReceivable.breakdown.BTC.amount", A027);

        int256 A028 = EP001 *latestSP004;
