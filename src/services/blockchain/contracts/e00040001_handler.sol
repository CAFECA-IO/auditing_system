...
contract E00040001Handler is ITransactionHandler{
    ...
    function processTransaction(bytes32[] memory data, address recorder) external override {
        ...
        require(data.length == 9, "Data length for E00030001 must be 9");
    ...
    function computeBalanceSheet() internal  {
        ...
        int256 A001_004_005_006_009 = int256(((-EP001 * latestSP004) + EP002 * latestSP002 + (-EP004 * latestSP002)) / 10**18);
        report.addValue(reportName, "balanceSheet", "assets.details.cryptocurrency.totalAmountFairValue", A001_004_005_006_009);
        ...
        report.addValue(reportName, "balanceSheet", "liabilities.details.userDeposit.breakdown.BTC.amount" , A046_044);

        int256 A002_007 = int256(EP002 + (-EP004));
        report.addValue(reportName, "balanceSheet", "assets.details.cryptocurrency.breakdown.USDT.amount", A002_007);
        report.addValue(reportName, "balanceSheet", "liabilities.details.userDeposit.breakdown.USDT.amount", A002_007);

        int256 A003_008 = int256((EP002 * latestSP002 + (-EP004 * latestSP002))/10**18);
        report.addValue(reportName, "balanceSheet", "assets.details.cryptocurrency.breakdown.USDT.fairValue", A003_008);
        report.addValue(reportName, "balanceSheet", "liabilities.details.userDeposit.breakdown.USDT.fairValue", A003_008);
        ...
        int256 A014 = int256(((-EP001 * latestSP004) + EP002 * latestSP002 + (-EP004 * latestSP002) + EP003 * latestSP002 + EP004 * latestSP002) / 10**18);
