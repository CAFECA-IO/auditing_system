...
contract E00040001Handler is ITransactionHandler{
    ...
    function computeBalanceSheet() internal  {
        ...
        report.addValue(reportID, "balanceSheet", "assets.details.cryptocurrency.breakdown.BTC.amount" , A046_044);
        report.addValue(reportID, "balanceSheet", "liabilities.details.userDeposit.breakdown.BTC.amount" , A046_044);

        int256 A002_007 = int256(EP002 + (-EP004));
        report.addValue(reportID, "balanceSheet", "assets.details.cryptocurrency.breakdown.USDT.amount", A002_007);
        report.addValue(reportID, "balanceSheet", "liabilities.details.userDeposit.breakdown.USDT.amount", A002_007);

        int256 A003_008 = int256((EP002 * latestSP002 + (-EP004 * latestSP002))/10**18);
        report.addValue(reportID, "balanceSheet", "assets.details.cryptocurrency.breakdown.USDT.fairValue", A003_008);
        report.addValue(reportID, "balanceSheet", "liabilities.details.userDeposit.breakdown.USDT.fairValue", A003_008);
