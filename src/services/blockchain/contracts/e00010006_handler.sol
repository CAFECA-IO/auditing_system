...
contract E00010006Handler is ITransactionHandler {
    ...
    function computeComprehesiveIncome() internal {
        ...
        report.addValue(reportID, "comprehensiveIncome", "costs.details.technicalProviderFee.breakdown.BTC.weightedAverageCost", B008_95_30);
        report.addValue(reportID, "comprehensiveIncome", "costs.weightedAverageCost", B008_95_30);
