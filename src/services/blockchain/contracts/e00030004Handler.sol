...
contract E00030004Handler is ITransactionHandler{
    ...
    function processTransaction(bytes32[] memory data, address recorder) external override {
        ...
        require(data.length == 10, "Data length for E00030004 must be 10");
    ...
    function computeBalanceSheet() internal  {
        ...
        int256 A020 = int256((EP001 * latestSP003  + EP009 * latestSP002) /(10**18));
        report.addValue(reportID, "balanceSheet", "assets.details.accountsReceivable.totalAmountFairValue", A020);

        int256 A027 = int256(EP001);
        report.addValue(reportID, "balanceSheet", "assets.details.accountsReceivable.breakdown.USDT.fairValue", A027);

        int256 A028 = int256(EP001*latestSP003);
        report.addValue(reportID, "balanceSheet", "assets.details.accountsReceivable.breakdown.BTC.fairValue", A028);

        int256 A004_005 = int256(((EP001 * latestSP003 + EP004 * latestSP002)  + (EP009 * latestSP002)) / (10**18));
        ...
        int256 A014 = int256(((-EP003 * latestSP002) + (EP003 * latestSP002) + (EP002 * latestSP002) + (-EP008 * latestSP002)+ (EP004 * latestSP002) + (EP009 * latestSP002)) / 10**18);
        ...
        int256 A052 = int256((EP001 * latestSP003 + EP002 * latestSP004) / 10**18);
        ...
        int256 A056 = int256(EP002 * latestSP002);
        ...
        int256 A060 = int256(((-EP001) * latestSP003)/(10**18));
