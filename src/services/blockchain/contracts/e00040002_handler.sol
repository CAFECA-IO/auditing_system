...
contract E00040002Handler is ITransactionHandler{
    ...
    function computeBalanceSheet() internal  {
        ...
        int256 A001_004_005_006_009 = int256(((-EP001 * latestSP004) + EP002 * latestSP003 + (-EP004 * latestSP002)) / 10**18);
        ...
        int256 A015 = int256(EP002 + (-EP003));
        report.addValue(reportID, "balanceSheet", "assets.details.cryptocurrency.breakdown.ETH.amount", A015);

        int256 A016_008 = int256((EP002 * latestSP003 + (-EP004 * latestSP002))/10**18);
        report.addValue(reportID, "balanceSheet", "assets.details.cryptocurrency.breakdown.ETH.fairValue", A016_008);
        report.addValue(reportID, "balanceSheet", "liabilities.details.userDeposit.breakdown.USDT.fairValue", A016_008);
        ...
        int256 A014 = int256(((-EP001 * latestSP004) + EP002 * latestSP003 + (-EP004 * latestSP002) + EP003 * latestSP002 + EP004 * latestSP002) / 10**18);
