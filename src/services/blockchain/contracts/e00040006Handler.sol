...
contract E00040005Handler is ITransactionHandler{
    ...
    function computeBalanceSheet() internal  {
        ...
        report.addValue(reportID, "balanceSheet", "assets.details.cryptocurrency.totalAmountFairValue", A001_004_005_006_009_042);
        report.addValue(reportID, "balanceSheet", "assets.totalAmountFairValue", A001_004_005_006_009_042);
        report.addValue(reportID, "balanceSheet", "totalAssetsFairValue", A001_004_005_006_009_042);
        report.addValue(reportID, "balanceSheet", "liabilities.details.userDeposit.totalAmountFairValue", A001_004_005_006_009_042);
        report.addValue(reportID, "balanceSheet", "liabilities.totalAmountFairValue ", A001_004_005_006_009_042);
        report.addValue(reportID, "balanceSheet", "liabilities.details.userDeposit.breakdown.ETH.amount ", A001_004_005_006_009_042);
        ...
        report.addValue(reportID, "balanceSheet", "liabilities.details.userDeposit.breakdown.USDT.fairValue" , A008);

        int256 A002_7 = -EP001;
        report.addValue(reportID, "balanceSheet", "assets.details.cryptocurrency.breakdown.USDT.amount " , A002_7);
        report.addValue(reportID, "balanceSheet", "liabilities.details.userDeposit.breakdown.USDT.amount" , A002_7);

        int256 A016 = EP002 * latestSP003;
        report.addValue(reportID, "balanceSheet", "assets.details.cryptocurrency.breakdown.ETH.fairValue" , A016);

        int256 A043 = int256((EP003 * latestSP002 + EP004 * latestSP002)/10**18);
        report.addValue(reportID, "balanceSheet", "liabilities.details.userDeposit.breakdown.ETH.fairValue" , A043);
