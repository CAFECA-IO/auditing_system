...
contract E00030005Handler is ITransactionHandler{
    ...
    function computeBalanceSheet() internal  {
        ...
        int256 A020_028_004_005 = int256(((-EP003 * latestSP002) + (-EP012 * latestSP002)) / 10**18);
        report.addValue(reportID, "balanceSheet", "assets.details.accountsReceivable.totalAmountFairValue" , A020_028_004_005);
        report.addValue(reportID, "balanceSheet", "assets.details.accountsReceivable.breakdown.BTC.fairValue" , A020_028_004_005);
        report.addValue(reportID, "balanceSheet", "assets.totalAmountFairValue" , A020_028_004_005);
        report.addValue(reportID, "balanceSheet", "totalAssetsFairValue" , A020_028_004_005);
        ...
        int256 A031 = int256(((-EP006 * latestSP002) + (EP002 * latestSP004) + (-EP011 * latestSP002) + (-EP003 * latestSP002) + (-EP001 * latestSP002)) / 10**18);
    ...
    function computeBalanceSheet2() internal{
        ...
        int256 A009 = int256((EP006 * latestSP002 +  (-EP006 * latestSP002) + (EP002 * latestSP004) + (-EP011 * latestSP002)+ (-EP003 * latestSP002) + (-EP001 * latestSP002))/10**18);
