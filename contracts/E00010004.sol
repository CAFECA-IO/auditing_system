...
contract E00010004 {
    ...
    function getEventIdAndRate(string memory _eventId,string memory _reportID ,int256 _SP002, int256 _SP003, int256 _SP004) public {
        ...
        if (keccak256(abi.encodePacked(eventIdFromTimeSpan)) == keccak256(abi.encodePacked(_eventId))) {
            ...
            EP007  = transactionContract.getTransactionParamByEventId(_eventId,"EP007");
            emit EventEP001(_eventId, EP001,EP002,EP003,EP004,EP006,EP007);
        }
        computeBalanceSheet();
    ...
    function computeBalanceSheet() internal  {
        ...
        int256 A003 = int256(((-EP001) + EP002 + EP003) * latestSP002);
        ...
        int256 A006_8_9 = int256((-EP001) * latestSP002);
        ...
        int256 A010_13 = int256((EP002 + EP003) * latestSP002 + ((-EP004) * latestSP003));
        ...
        int256 A012 = int256((EP002 + EP003) * latestSP002);
        ...
        int256 A014 = int256((EP001 + EP003) * latestSP002 + ((-EP004) * latestSP003));
        ...
        int256 A016_18 = int256((-EP004) * latestSP003);
    ...
    function computeComprehesiveIncome() internal {
        ...
        int256 B004 = int256((EP002 + EP003) * EP006 + ((-EP004) * EP007));
        ...
        int256 B005_7 = int256((EP002 + EP003) * EP006);
        ...
        int256 B008_10 = int256( ((-EP004) * EP007));
    ...
    function computeCashFlow() internal {
        ...
        int256 C006 = int256((EP002 + EP003) * EP006);
        ...
        int256 C007_8 = int256(((-EP001) + EP002 + EP003) * EP006 + ((-EP004) * EP007));
        ...
        int256 C009_11 = int256(((-EP001) * EP006));
        ...
        int256 C012_14 = int256((-EP004) * EP007);
