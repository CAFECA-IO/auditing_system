...
contract RouterContract {
    ...
    createTimeSpanReport private timeSpanReport;
    ...
    constructor(address _transactionContract, address _timeSpanReport) {
        ...
        timeSpanReport = createTimeSpanReport(_timeSpanReport);
    }
    ...
    function registerHandler(bytes32 transactionType, address handlerAddress) public {
        TransactionHandler handler = TransactionHandler(handlerAddress);
