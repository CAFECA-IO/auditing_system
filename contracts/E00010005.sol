...
contract E00010005 {
    ...
    function computeBalanceSheet() internal  {
        ...
        int256 A001_4_5_16 = int256(((-EP001) + EP002 + EP003) * latestSP003 + ((-EP004) * latestSP003));
        ...
        int256 A006_43_9 = int256((-EP001) * latestSP003);
    ...
    function computeComprehesiveIncome() internal {
        ...
        int256 B008_10 = int256( ((-EP004) * EP006));
    ...
    function computeCashFlow() internal {
        ...
        int256 C009_57 = int256(((-EP001) * EP006));
        ...
        int256 C004_73 = int256( (EP002 + EP003) * EP006);
        ...
        int256 C012_14 = int256((-EP004) * EP006);
