...
contract E00010003 {
    ...
    function computeBalanceSheet() internal  {
        ...
        int256 A001_47_4_5_14 = int256((EP001 + EP003) * latestSP004/100);
        ...
        int256 A006_45_9 = int256((EP001 - EP002) * latestSP004/100);
        ...
        int256 A010_49_13 = int256((EP002 + EP003) * latestSP004/100);
    ...
    function computeComprehesiveIncome() internal {
        int256 B001_37_4 = int256((EP002 + EP003) * EP005/100);
        string[] memory keysForB001_37_4 = new string[](3);
        keysForB001_37_4[0] = "income.details.depositFee.weightedAverageCost";
        keysForB001_37_4[1] = "income.details.depositFee.breakdown.ETH.weightedAverageCost";
        ...
        keysForB036[0] = "income.details.depositFee.breakdown.ETH.amount";
        report.addValue(reportID, "comprehensiveIncome", keysForB036[0], B036);
    }
//
    function computeCashFlow() internal {
        int256 C001_53 = int256((EP001 - EP002) * EP005/100);
        ...
        int256 C004_73 = int256((EP002 + EP003) * EP005/100);
