...
async function fetchData() {
  ...
  /*A022*/const capital_details_retainedEarnings_totalAmountFairValue = await getContractValue(reportID, "balanceSheet","capital.details.retainedEarnings.totalAmountFairValue");
